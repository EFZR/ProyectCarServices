...
namespace ProyectCarServices
{
    ...
    {
        FrmDetallesFactura detallesFactura;
        CSHerramientaBaseDatos datos;
        CSItems items;

        public FrmUsuarioEmpleado()
        {
            InitializeComponent();
            detallesFactura = new FrmDetallesFactura();
        ...
        {
            FrmBusquedadClientesGrid frmBusquedad = new FrmBusquedadClientesGrid();
            frmBusquedad.Show();
            this.Hide();
        }

        private void FrmUsuarioEmpleado_FormClosed(object sender, FormClosedEventArgs e)
        {
